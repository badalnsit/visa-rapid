...
export const metadata = {
    title: 'Citizenship by Investment: USA vs Portugal — Which One Actually Makes Sense in 2026? | Visa Rapid',
    ...
    return (
        <div className="bg-white min-h-screen">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
                ...
                {/* Related Articles */}
                <div className="mt-16">
                    <RelatedArticles currentPath="/blogs/citizenship-by-investment-usa-vs-portugal-2026" />
                </div>
            </div>
        </div>
    )
