...
export const metadata = {
    title: 'Why Dual Citizenship Might Not Be Worth It: The Downsides Nobody Talks About | Visa Rapid',
    ...
    return (
        <div className="bg-white min-h-screen">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
                ...
                <RelatedArticles currentPath="/blogs/dual-citizenship-downsides" />
            </div>
        </div>
    )
}
