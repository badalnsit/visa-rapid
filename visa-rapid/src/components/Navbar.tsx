      ...
      <div className="max-w-9xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden lg:flex items-center space-x-2">
            <a href="https://wa.me/+919910578099" target="_blank" rel="noopener noreferrer" className="bg-green-500 hover:bg-green-600 !text-white px-5 py-3 text-base font-bold transition-all duration-200 rounded-lg flex items-center gap-3">
