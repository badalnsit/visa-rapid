        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden lg:block flex-1">
            <div className="flex items-baseline justify-center space-x-2">
              ...
              <Link href="/residency" className="!text-black px-3 py-3 text-sm font-medium transition-colors hover:!text-gray-600 flex items-center gap-1 whitespace-nowrap">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {isMenuOpen && (
          <div className="lg:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white border-t border-gray-200">
              ...
              <Link href="/residency" className="!text-black  px-4 py-3 text-lg font-medium hover:bg-gray-50 flex items-center gap-3">
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                </svg>
                Passive Income Visa
